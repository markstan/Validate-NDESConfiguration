...
function Test-WindowsFeaturesInstalled {
    ...
    New-LogEntry "Checking Windows Features are installed..." -Severity 1 -LogFilePath $LogFilePath
    ...
    foreach($WindowsFeature in $WindowsFeatures){
        ...
        if($Feature.installed){
            ...
            New-LogEntry "$($FeatureDisplayName) Feature Installed" -Severity 1 -LogFilePath $LogFilePath
        }
        else {
            Write-Output "Error: $FeatureDisplayName Feature not installed!"  
            New-LogEntry "$($FeatureDisplayName) Feature not installed!" -Severity 3 -LogFilePath $LogFilePath
        }
    }
} 
